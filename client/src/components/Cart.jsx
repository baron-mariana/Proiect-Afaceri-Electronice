...
import { useDispatch, useSelector } from "react-redux";
import { updateCart, removeFromCart, clearCart } from "../store/slices/cartSlice";
import { useState } from "react";
import { createOrder } from "../routes/orders";
import { toast } from "react-toastify";
...
const Cart = () => {
  ...
  return (
    <div>
      <div className="cart-container">
        <div className="w-1/4 flex flex-col justify-center">
          <label htmlFor="name-input" className="block mb-1 text-sm font-medium">
            Name
          </label>
          <input
            type="text"
            ...
            value={formData.name}
            onChange={handleChange}
            className="bg-gray-50 border rounded-lg p-2.5"
          />

          <label htmlFor="phone-input" className="block mt-4 mb-1 text-sm">
            Phone
          </label>
          <input
            type="text"
          ...
          <label htmlFor="address-input" className="block mt-4 mb-1 text-sm">
            Address
          </label>
          <input
            type="text"
          ...
          <label htmlFor="city-input" className="block mt-4 mb-1 text-sm">
            City
          </label>
          <input
            type="text"
